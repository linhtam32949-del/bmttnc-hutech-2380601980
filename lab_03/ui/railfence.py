...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_key.setGeometry(QtCore.QRect(170, 230, 581, 41))
        self.txt_key.setObjectName("txt_key")
        self.txt_cipher = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher.setGeometry(QtCore.QRect(170, 300, 581, 91))
        ...
        self.txt_plain.setGeometry(QtCore.QRect(170, 120, 581, 91))
        self.txt_plain.setObjectName("txt_plain")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(110, 230, 41, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(290, 40, 291, 41))
        font = QtGui.QFont()
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(190, 450, 93, 28))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(610, 450, 93, 28))
